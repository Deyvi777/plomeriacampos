...
![Go 语言编译原理——词法分析](https://images.godruoyi.com/services/202103/22/gxI2xaLqVqwSfnjzOAalfmYKKIu5idtFYKREkDsW.png)
图 1.0 词法分析
...
![Go 语言编译原理——语法分析](https://images.godruoyi.com/services/202103/22/cu0uJeewgtcWhNDXusRY9WnwNU40KVYFnpeZmMwy.png)
图 2.0 语法分析
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/U9MApMQhkRK20tskuzkDCuVlJampwKFdN8KqFOpa.png)
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/3ACspPvk1u4cCFeB6dLv3CZKacD2WAWitOy1zaIj.png)
图 3.1 buf初始化

然后解析器开始一个字符一个字符的读取并分析，但由于 buf 目前是空的，第一次解析时会尝试读取目标文件内容到 buf 中；针对上面的 main.go 文件，读取后 buf 内容为：

![file](https://images.godruoyi.com/services/202103/22/DoaQcreU3H1hJvaceePAbJldHXOxkRvXObbaga4x.png)
图 3.2 读取文件内容
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/BUhsJNgRCQLKkhiq7sEeiLxUWcFc8uv6iqDCdpsj.png)
图 3.3 解析第一个 token
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/JbNNKN7Pns5IhAkmdnjlaHKXtvBJ4vkYAZg6btI2.png)
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/dau6aCGnFgaehulzA8jOMhJkY4ikvBW8C7LN1Maa.png)
图 3.5 第二次解析结束
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/zHxU5niPSF9EUUnoqvpeqIXF7cwhIJaHhjjtxY7W.png)
...
![Go 语言编译原理——词法&语法分析](https://images.godruoyi.com/services/202103/22/Yi1h8k6auMkUzcpjilweO87FRS5y5dkTwZsNR3Z9.png)
...
- 当前 [Go 语言的词法分析和语法分析(1)](https://godruoyi.com/services/golang-lexer-and-parser-1)
- [Go 语言的词法分析和语法分析(2)-Import申明的解析](https://godruoyi.com/services/go-lexical-analysis-and-syntax-analysis-2-parsing-of-import-declarations)
